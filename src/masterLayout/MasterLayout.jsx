...
const MasterLayout = ({children}) => {
    ...
    useEffect(() => {
        ...
        const getUserData = () => {
            try {
                // Try to get from localStorage (if you store it after login)
                const storedUser = localStorage.getItem("auth_user");
                if (storedUser) {
                    const user = JSON.parse(storedUser);
                    setUserData({
                        name: user.name || "User", role: user.roles?.[0] || "User" // Assuming roles is an array
                    });
                }
            } catch (error) {
    ...
    return (<section className={mobileMenu ? "overlay active" : "overlay "}>
            {/* sidebar */}
            <aside
                className={sidebarActive ? "sidebar active " : mobileMenu ? "sidebar sidebar-open" : "sidebar"}
            >
                <button
                ...
                <div className='sidebar-menu-area'>
                    <ul className='sidebar-menu' id='sidebar-menu'>
                            ...
                            <ul className='sidebar-submenu'>
                                <li>
                                    <NavLink to='/' className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/> Overview
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        {/* Catalog */}
                        <li className='sidebar-menu-group-title'>Catalog</li>
                        <li className='dropdown'>
                            <Link to='#'>
                            ...
                            <ul className='sidebar-submenu'>
                                ...
                                <li>
                                    <NavLink to='/categories'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-warning-main w-auto'/> Categories
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/brands'
                                ...
                                <li>
                                    <NavLink
                                        to="/attributes"
                                        className={() => window.location.pathname.startsWith("/attributes") ? "active-page" : ""}
                                    >
                                        <i className='ri-circle-fill circle-icon text-purple w-auto'/> Attributes
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/tags'
                                ...
                                <li>
                                    <NavLink to='/product-seo'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-cyan w-auto'/> Product SEO
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/product-faq'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-danger-main w-auto'/> Product FAQs
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/stock-logs'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-lilac-600 w-auto'/> Stock Logs
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='dropdown'>
                            ...
                            <ul className='sidebar-submenu'>
                                <li>
                                    <NavLink to='/orders'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/> All Orders
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/orders/pending'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-warning-main w-auto'/> Pending
                                        Orders
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/orders/returns'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-danger-main w-auto'/> Returns
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/orders/refunds'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-danger-main w-auto'/> Refunds
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        {/* Shipping */}
                        <li className='sidebar-menu-group-title'>Shipping</li>
                        <li className='dropdown'>
                            <Link to='#'>
                                <Icon icon='mdi:truck-delivery-outline' className='menu-icon'/>
                                <span>Shipping</span>
                            </Link>
                            <ul className='sidebar-submenu'>
                                <li>
                                    <NavLink to='/shipping'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/> Shipping
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='dropdown'>
                            <Link to='#'>
                                <Icon icon='mdi:lifebuoy' className='menu-icon'/>
                                <span>Support</span>
                            </Link>
                            <ul className='sidebar-submenu'>
                                <li>
                                    <NavLink to='/support/enquiries'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/> Enquiries
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/support/tickets'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-success-main w-auto'/> Tickets
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='dropdown'>
                            ...
                            <ul className='sidebar-submenu'>
                                <li>
                                    <NavLink to='/pricing'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/> Product
                                        Pricing
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/taxs'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-warning-main w-auto'/> Tax Rules
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className='sidebar-menu-group-title'>Promotions &amp; Discounts</li>
                        <li className='dropdown'>
                            <Link to='#'>
                            ...
                            <ul className='sidebar-submenu'>
                                <li>
                                    <NavLink to='/offers/auto-discounts'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/> Auto
                                        Discounts
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/offers/bogo-offers'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-success-main w-auto'/> BOGO Offers
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/offers/combo-offers'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-info-main w-auto'/> Combo Offers
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/offers/coupons'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-warning-main w-auto'/> Coupons
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to='/offers/flash-sales'
                                             className={(navData) => (navData.isActive ? 'active-page' : '')}>
                                        <i className='ri-circle-fill circle-icon text-danger-main w-auto'/> Flash Sales
                                    </NavLink>
                                </li>
                            </ul>
                        </li>
                        ...
                        {/* Loyalty & Rewards */}
                        <li className='sidebar-menu-group-title'>Loyalty &amp; Rewards</li>
                        <li>
                        ...
                        {/* Account & Security */}
                        <li className='sidebar-menu-group-title'>Account &amp; Security</li>
                        <li>
                            <NavLink to='/2fa/enable' className={(navData) => (navData.isActive ? 'active-page' : '')}>
                        ...
                        <li className='dropdown'>
                            <Link to='#'>
                                <Icon icon='mdi:shield-account-outline' className='menu-icon'/>
                                <span>Admin</span>
                            </Link>
                            <ul className='sidebar-submenu'>
                                <li>
                ...
                <footer className='d-footer'>
                    <div className='row align-items-center justify-content-center'>
                        <div className='col-auto text-center'>
                            <p className='mb-0'>© 2025 Agumentik. All Rights Reserved.</p>
                        </div>
                    </div>
                </footer>
            </main>
